...
@section('content')
    <div class="card mb-4">
        ...
        @endif
        <h5 class="halaman">Halaman : <a href="#" class="text-primary" style="text-decoration: none">{{ $buku->halaman }}</a></h5>
        <h5 class="isbn">ISBN : <a href="#" class="text-primary" style="text-decoration: none">{{ $buku->isbn }}</a></h5>
        ...
        <h5 class="stok">Stok : <span class="text-primary">{{ $buku->stok }}</span></h5>
        ...
        <p class="card-text m-0">Dilihat: {{ $buku->views }} kali</p>
        <p class="card-text m-0">Dipinjam: {{ $buku->borrowed_count }} kali</p>
