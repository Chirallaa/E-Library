    ...
    <div class="card mb-4">
        ...
        <div class="card-body">
            <form action="/buku/{{ $buku->id }}" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group mb-3">
                    <label for="halaman" class="text-primary font-weight-bold">Halaman</label>
                    <input type="text" name="halaman" class="form-control" value="{{ old('halaman', $buku->halaman) }}">
                </div>
                ...
                <div class="form-group mb-3">
                    <label for="isbn" class="text-primary font-weight-bold">ISBN</label>
                ...
                <div class="form-group mb-3">
                    <label for="kategori" class="text-primary font-weight-bold">Katalog</label>
                ...
                <div class="form-group mb-3">
                    ...
                    <input type="number" name="stok" class="form-control" id="stok" value="{{ old('stok', $buku->stok) }}" required>
                </div>
