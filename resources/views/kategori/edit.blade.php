...
@section('judul')
    <h2 class="text-primary">Edit Katalog</h2>
@endsection

@section('content')
    <div class="card px-4 pt-3 pb-5">
        <form action="/katalog/{{ $kategori->id }}" method="post">
            @csrf
            @method('put')
            <div class="form-group">
                <label for="formGroupExampleInput">Nama Katalog</label>
            ...
            <div class="d-flex justify-content-end">
                <a href="/katalog" class="btn btn-danger mx-2 px-3">Batal</a>
